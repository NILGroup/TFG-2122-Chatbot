...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.8]{Imagenes/Vectorial/diagrama_entidad_relacion_mysql}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.65]{Imagenes/Vectorial/funcionalidad_login1}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.8]{Imagenes/Vectorial/funcionalidad_chatbot1}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.8]{Imagenes/Vectorial/funcionalidad_nuevo_paciente1}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.75]{Imagenes/Vectorial/funcionalidad_historia_vida1}

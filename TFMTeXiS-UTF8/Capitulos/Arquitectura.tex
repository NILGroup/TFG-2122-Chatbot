...
%Faltos de ese dataset de recuerdos para el análisis de sentimientos se buscó uno que no tuviese nada que ver pero que podría servir para hacer una buena predicción en negativo y positivo. Viendo que algo no debía estar funcionando bien y que la solución podía estar en las dimensiones del dataset.
